...
from .forms import (
    ...
    MyPasswordResetForm, MySetPasswordForm, RecipeCreateForm, ContactForm,
)
...
class Recommended(generic.TemplateView):
    template_name = 'blog/recommended.html'
...
class Information(generic.TemplateView):
    template_name = 'blog/information.html'
...
class Ranking(generic.TemplateView):
    template_name = 'blog/ranking.html'
...
class PasswordReset(PasswordResetView):
    """パスワード変更用URLの送付ページ"""
    subject_template_name = 'blog/mail_template/password_reset/subject.txt'
    email_template_name = 'blog/mail_template/password_reset/message.txt'
...
class RecipeFilterView(generic.ListView):

    """
    ビュー：フィルターのやつ
    """
    model = Recipe
    template_name = 'blog/recipe.html'
...
class RecipeCreateView(generic.CreateView):
    ...
    success_url = reverse_lazy('blog:recipe')
...
class RecipeUpdateView(OnlyYouMixin, generic.UpdateView):
    """
    ビュー：更新画面
    """
    model = Recipe
...
class RecipeDeleteView(OnlyYouMixin, generic.DeleteView):
    """
    ビュー：削除画面
    """
    model = Recipe
